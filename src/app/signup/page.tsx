                ...
                <div className="max-w-[400px] w-full p-6 bg-white dark:bg-slate-900 shadow-md shadow-slate-100 dark:shadow-slate-800 rounded-md">
                    ...
                    <form className="text-start">
                        <div className="grid grid-cols-1">
                            ...
                            <div className="mb-4">
                                <Link href="" className="h-10 px-5 tracking-wide inline-flex items-center justify-center font-medium rounded-md bg-violet-600 text-white w-full">Register</Link>
                            </div>
