                ...
                <div className="grid md:grid-cols-12 grid-cols-1 gap-2 items-center">
                    ...
                    <div className="lg:col-span-7 md:col-span-8 md:text-end">
                        <ul className="tracking-[0.5px] mb-0 inline-flex items-center">
                            <li className="inline-block items-center text-slate-400 dark:text-white/60 duration-500 ease-in-out hover:text-violet-600 dark:hover:text-white"><Link href="/">Edupath</Link></li>
                            ...
                            <li className="inline-block items-center text-slate-400 dark:text-white/60 duration-500 ease-in-out hover:text-violet-600 dark:hover:text-white"><Link href="">Courses</Link></li>
                            <li className="inline-block items-center text-slate-500 dark:text-white/60 mx-0.5 ltr:rotate-0 rtl:rotate-180"><FiChevronRight className="align-middle"/></li>
