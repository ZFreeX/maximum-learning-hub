...
export default function GetInTouch() {
  return (
        <div className="grid grid-cols-1 text-center">
            ...
            <div className="mt-6">
                <Link href="/contactus" className="h-10 px-5 tracking-wide inline-flex items-center justify-center font-medium rounded-md bg-violet-600 text-white"><FiPhone className="align-middle me-2"/> Contact us</Link>
            </div>
        </div>
  )
}
